...
#include <sigmaengine/chain/shared_authority.hpp>
...
namespace sigmaengine { namespace chain {
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = SIGMAENGINE_NULL_ACCOUNT;
         ...
         uint16_t          mining = 0;
         asset             after_mining_balance = asset( 0, SGT_SYMBOL );
         
         uint32_t          nsta602_count = 0;
         uint32_t          nsta602_create_count = 0;
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_mining >,
            composite_key< account_object,
               member< account_object, uint16_t, &account_object::mining >,
               member< account_object, asset, &account_object::balance >,
               member< account_object, account_id_type, &account_object::id >
            >,
            composite_key_compare< std::greater< uint16_t >, std::greater< asset >, std::less< account_id_type > >
         >
      >,
...
FC_REFLECT( sigmaengine::chain::account_object,
             ...
             (banned)
             (post_count)
             (mining)(after_mining_balance)
             (nsta602_count)(nsta602_create_count)
             (last_post)(last_root_post)
          )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::account_object, sigmaengine::chain::account_index )

FC_REFLECT( sigmaengine::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::account_authority_object, sigmaengine::chain::account_authority_index )


FC_REFLECT( sigmaengine::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::owner_authority_history_object, sigmaengine::chain::owner_authority_history_index )

FC_REFLECT( sigmaengine::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::account_recovery_request_object, sigmaengine::chain::account_recovery_request_index )

FC_REFLECT( sigmaengine::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::change_recovery_account_request_object, sigmaengine::chain::change_recovery_account_request_index )
