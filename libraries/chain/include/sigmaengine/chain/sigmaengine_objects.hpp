...
namespace sigmaengine { namespace chain {
   ...
   class transaction_fee_vote_object : public object< transaction_fee_vote_object_type, transaction_fee_vote_object >
   {
      public:
         template< typename Constructor, typename Allocator >
         transaction_fee_vote_object( Constructor&& c, allocator< Allocator > a )
         {
            c( *this );
         }
         ...
         uint32_t                vote_block = 0;
   };

   class transaction_fee_reward_object : public object< transaction_fee_reward_object_type, transaction_fee_reward_object>
   {
      public:
         template< typename Constructor, typename Allocator >
         transaction_fee_reward_object( Constructor&& c, allocator< Allocator > a )
         {
            c( *this );
         }

         transaction_fee_reward_object(){}

         id_type                   id;
         asset                     fund_balance = asset( 0, SGT_SYMBOL );
         uint32_t                  reward_block = 0;
   };

   class mining_reward_turn_object : public object< mining_reward_turn_object_type, mining_reward_turn_object>
   {
      public:
         template< typename Constructor, typename Allocator >
         mining_reward_turn_object( Constructor&& c, allocator< Allocator > a )
         {
            c( *this );
         }

         mining_reward_turn_object(){}

         id_type                   id;
         uint32_t                  turn = 0;
         asset                     amount = asset( 0, SGT_SYMBOL );
         uint32_t                  start_block = 0;
         uint32_t                  stop_block = 0;
   };
   ...
   struct by_voter;
   typedef multi_index_container <
      transaction_fee_vote_object,
      indexed_by <
         ordered_unique < tag < by_id >,
            member < transaction_fee_vote_object, transaction_fee_vote_id_type, &transaction_fee_vote_object::id >
         >,
         ordered_unique < tag < by_voter >,
            composite_key< transaction_fee_vote_object,
               member < transaction_fee_vote_object, account_name_type, &transaction_fee_vote_object::voter >
            >
         >
      >,
      allocator < transaction_fee_vote_object >
   > transaction_fee_vote_index;

   typedef multi_index_container<
      transaction_fee_reward_object,
      indexed_by<
         ordered_unique< tag< by_id >, member< transaction_fee_reward_object, transaction_fee_reward_id_type, &transaction_fee_reward_object::id > >
      >,
      allocator< transaction_fee_reward_object >
   > transaction_fee_reward_index;

   struct by_turn;
   typedef multi_index_container<
      mining_reward_turn_object,
      indexed_by<
         ordered_unique< tag< by_id >, member< mining_reward_turn_object, mining_reward_turn_id_type, &mining_reward_turn_object::id > >,
         ordered_unique< tag< by_turn >, 
            member< mining_reward_turn_object, uint32_t, &mining_reward_turn_object::turn >,
            std::greater< uint32_t >
         >
      >,
      allocator< mining_reward_turn_object >
   > mining_reward_turn_index;
} } // sigmaengine::chain
...
FC_REFLECT( sigmaengine::chain::transaction_fee_vote_object,
   ( id )
   ( voter )
   ( trx_fee )
   ( vote_block )
)
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::transaction_fee_vote_object, sigmaengine::chain::transaction_fee_vote_index )

FC_REFLECT( sigmaengine::chain::transaction_fee_reward_object,
            (id)
            (fund_balance)
            (reward_block)
         )
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::transaction_fee_reward_object, sigmaengine::chain::transaction_fee_reward_index )

FC_REFLECT( sigmaengine::chain::mining_reward_turn_object,
            (id)
            (turn)
            (amount)
            (start_block)
...
CHAINBASE_SET_INDEX_TYPE( sigmaengine::chain::mining_reward_turn_object, sigmaengine::chain::mining_reward_turn_index )
