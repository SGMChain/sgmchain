...
#define SIGMAENGINE_VERSION                                         ( version(0, 1, 2) )
...
#define SIGMAENGINE_BLOCKCHAIN_PRECISION_DIGITS                     8

#define SIGMAENGINE_INIT_PUBLIC_KEY_STR                             "SGM5zN1bZg8Zapqdco9PCuYWHtm3Rmo1RCLCr1JBtPMumTdGx1bzD" // 5JCvj3Dx9D3BE9FYRH7Apj6Emnxmvks4aQAj5ZKGjJX6pveRfjB
#define SIGMAENGINE_CHAIN_ID                                        (fc::sha256::hash("sgm_mainnet")) //(sigmaengine::protocol::chain_id_type())
#define SGT_SYMBOL                                                  (uint64_t(SIGMAENGINE_BLOCKCHAIN_PRECISION_DIGITS) | (uint64_t('S') << 8) | (uint64_t('G') << 16) | (uint64_t('M') << 24) )
#define SIGMAENGINE_ADDRESS_PREFIX                                  "SGM"
#define SIGMAENGINE_GENESIS_TIME                                    (fc::time_point_sec(1640995200))
...
#define SIGMAENGINE_REWARD_ACCOUNT                                   "reward"
...
#define SIGMAENGINE_TRANSACTION_FEE                                 asset( 0, SGT_SYMBOL ) 
...
#ifdef IS_TEST_NET
#define SIGMAENGINE_MAX_FEED_AGE_SECONDS                         (60*60*24*7) // 20 min
#define SIGMAENGINE_MIN_FEEDS                                    3 //(SIGMAENGINE_NUM_BOBSERVERS/3) /// protects the network from conversions before price has been established
#define SIGMAENGINE_CHECK_DAPP_CYCLE                              fc::minutes(10)
#else
#define SIGMAENGINE_MAX_FEED_AGE_SECONDS                         (60*60*24*7) // 7 days
#define SIGMAENGINE_CHECK_DAPP_CYCLE                             fc::hours(1)
...
#define SIGMAENGINE_REFRESH_TRANSACTION_FEE_BLOCK_CYCLE           1200
