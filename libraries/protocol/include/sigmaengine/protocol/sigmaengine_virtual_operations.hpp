...
namespace sigmaengine { namespace protocol {
   ...
   struct dapp_fee_virtual_operation : public virtual_operation
   {
      ...
      dapp_fee_virtual_operation( const account_name_type& _account, const dapp_name_type& _dapp_name, const asset& _reward )
         : account(_account), dapp_name( _dapp_name ), reward( _reward ) {}
   ...
   struct dapp_reward_virtual_operation : public virtual_operation
   {
      ...
      dapp_reward_virtual_operation( const account_name_type& _account, const asset& _reward )
         : account( _account ), reward( _reward ) {}
         
      account_name_type  account;
      asset              reward;
   };

   struct tx_fee_virtual_operation : public virtual_operation
   {
      tx_fee_virtual_operation(){}
      tx_fee_virtual_operation( const account_name_type& _account, const string& _op_name, const asset& _reward )
         : account(_account), op_name( _op_name ), reward( _reward ) {}
   ...
   struct tx_reward_virtual_operation : public virtual_operation
   {
      tx_reward_virtual_operation(){}
      tx_reward_virtual_operation( const account_name_type& _account, const asset& _reward )
         : account( _account ), reward( _reward ) {}
...
FC_REFLECT( sigmaengine::protocol::shutdown_bobserver_operation, (owner) )
FC_REFLECT( sigmaengine::protocol::hardfork_operation, (hardfork_id) )
FC_REFLECT( sigmaengine::protocol::fill_staking_fund_operation, (from)(fund_name)(amount)(request_id)(memo) )
FC_REFLECT( sigmaengine::protocol::fill_transfer_savings_operation, (from)(to)(amount)(total_amount)(split_pay_order)(split_pay_month)(request_id)(memo) )
FC_REFLECT( sigmaengine::protocol::dapp_fee_virtual_operation, ( account )( dapp_name )( reward ) )
FC_REFLECT( sigmaengine::protocol::dapp_reward_virtual_operation, ( account )( reward ) )
FC_REFLECT( sigmaengine::protocol::tx_fee_virtual_operation, ( account )( reward ) )
FC_REFLECT( sigmaengine::protocol::tx_reward_virtual_operation, ( account )( reward ) )

FC_REFLECT( sigmaengine::protocol::fill_token_staking_fund_operation, 
            ( from )
            ( token ) 
            ( fund_name )
            ( amount )
...
FC_REFLECT( sigmaengine::protocol::fill_transfer_token_savings_operation, 
            ( from )
            ( to )
            ( token ) 
            ( request_id )
