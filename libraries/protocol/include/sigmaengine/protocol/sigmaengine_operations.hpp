...
namespace sigmaengine { namespace protocol {
    ...
    * @ingroup operations
    *
    * @brief Transfers SGM from one account to another.
    */
   ...
   struct vote_transaction_fee_operation : public base_operation
   {
   ...
   struct set_mining_account_operation : public base_operation
   {
      account_name_type root;
      account_name_type account;
   ...
   struct mining_reward_process_start_operation : public base_operation
   {
      account_name_type root;
      uint32_t          turn;
      asset             amount;
   ...
   struct mining_reward_process_stop_operation : public base_operation
   {
      account_name_type root;
      uint32_t          turn;
   ...
   struct transfer_mining_reward_operation : public base_operation
   {
      account_name_type from;
      account_name_type to;
      asset             amount;
...
FC_REFLECT( sigmaengine::protocol::vote_transaction_fee_operation, (voter)(trx_fee) )

FC_REFLECT( sigmaengine::protocol::set_mining_account_operation, (root)(account)(mining) )
FC_REFLECT( sigmaengine::protocol::mining_reward_process_start_operation, (root)(turn)(amount) )
FC_REFLECT( sigmaengine::protocol::mining_reward_process_stop_operation, (root)(turn) )
FC_REFLECT( sigmaengine::protocol::transfer_mining_reward_operation, (from)(to)(amount)(memo) )
