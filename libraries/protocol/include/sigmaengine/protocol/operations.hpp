...
namespace sigmaengine { namespace protocol {
   ...
   typedef fc::static_variant<
            ...
            vote_transaction_fee_operation,
            tx_reward_virtual_operation,
            tx_fee_virtual_operation,

            set_mining_account_operation,
            mining_reward_process_start_operation,
            mining_reward_process_stop_operation,

            transfer_mining_reward_operation,
